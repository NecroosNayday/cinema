...
if( isset($_SESSION['logged_user'])){echo "<p class=\"text-light mb-0\">Здравствуйте ".$_SESSION['logged_user']->login."</p>";}?>
       ...
       <button id="reg" class="btn btn-outline-success my-2 my-sm-0" id="regbut"type="button" data-toggle="modal" data-target="#exampleModal2">Регистрация</button>
      </form>
    </div>
  </nav>
</header>
...
<main role="main" class="flex-shrink-0">
 ...
 <h2 class="text-center mt-4">В трендах</h2>
